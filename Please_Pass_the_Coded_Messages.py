...
is part of the code is that it is divisible by 3. You can do smaller numbers like 15 and 45 easily, but bigger 
numbers like 144 and 414 are a little trickier. Write a program to help yourself quickly create large numbers for 
...
while(sum_arr % 3 != 0):
    if(sum_arr % 3 == 1):
        if(1 in arr):
            ...
            arr.pop() # test case 7 7 9 [prime numbers]
